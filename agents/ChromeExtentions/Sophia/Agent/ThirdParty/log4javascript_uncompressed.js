 ...
 *
 * Changed By: Avishay Ben Shabtai.
 * Office Address: Mercury Interactive (Israel) Limited
 *				   Shabazi st. No 26 
 *				   Yehud 
 *				   Israel 
 *				   56100
 * Changes to addWindowLoadListener by Avishay BS. (Hewlett-Packard Development Company, L.P)
 *
 * Changed By: XU Chang-Mao<changmao.xu@hp.com>
 * Office Address: ShangHai Hewlett-Packard Limited
 *                 No. 20 Jia Feng Road
 *                 WGQ, FTZ, Pudong
 *                 Shanghai  
 *                 CHINA  
 *                 200131
 * 1. Add code to get DOM window using Firefox extension SDK API. 
 * 2. Export the interface log4javascript
 * 3. Modify code in function BrowserConsoleAppender. Using object console provided by 
 *    Firefox instead of window.console to make Firefox extensions.sdk.console.loglevel 
 *    setting effective 

 * Changed By: Easton Liu
 * Office Address: ShangHai Hewlett-Packard Limited
 *                 No. 20 Jia Feng Road
 *                 WGQ, FTZ, Pudong
 *                 Shanghai  
 *                 CHINA  
 *                 200131
 * Modify the code to self adapt for Firefox add-onAdd code to get DOM window using Firefox extension SDK API:
 *    1. get DOM window for Firefox add-on SDK when window is undefined and require is defined as function.
 *    2. ensure console object is available on window for Firefox add-on.
 *    
 * Changed By: Easton Liu
 * Office Address: ShangHai Hewlett-Packard Limited
 *                 No. 20 Jia Feng Road
 ...
 *                 CHINA  
 *                 200131
 * Modify the code to comply with Firefox add-on hub review.
 *  1. remove protection of Function.prototype.apply and Function.prototype.call.
 *  2. remove ConsoleAppender, PopUpAppender and InPageAppender
 */
...
if (typeof window === "undefined" && typeof require === "function" && typeof (require("sdk/window/utils")) === "object") {
    // Ensure that window object is available. This is necessary for log4javascript
...
if (window && (window.console === null || window.console === undefined) && typeof console != "undefined" ) {
    // Ensure that console object is available in the window. This is necessary for log4javascript to be
    // available for Firefox add-on.
...
if (typeof exports !== "undefined") {
    // Ensure that log4javascript object is available via exports. This is necessary
    // for log4javascript to be available in Firefox add-on.
