...
var DEFAULT_RESET_URL = 'C:\\sop.html?testId={TEST_ID}&baseAppUrl={BASE_APP_URL}&dataUrl={DATA_URL}&fileUploadUrl={FILE_UPLOAD_URL}';
...
Protractor.prototype.get = function(destination, opt_timeout) {
  ...
  this.driver.get(this.resetUrl.replace('{TEST_ID}', global.sophiaTestID).replace('{BASE_APP_URL}', global.appBaseUrl).replace('{DATA_URL}', global.dataUrl).replace('{FILE_UPLOAD_URL}', global.fileUploadUrl));
  this.executeScript_(
