...
var queries = {
    ...
    formatUIObjectAttributeQuery: function(attribute, terms)
    {
    ...
    searchUIObjects: function(patternsObj, dateCondition, callback) {
        ...
        if (query.length > 1 && patternsObj.colorSearches && 
            ...
            query += ') AND (';
        query += this.formatUIObjectAttributeQuery('color', patternsObj.colorSearches);
        if (query.length > 1 && patternsObj.colorSearches && 
            patternsObj.colorSearches.length > 0)
            query += ') AND (';
        query += this.formatUIObjectAttributeQuery('background', patternsObj.colorSearches);
        query += ')';
