...
var queries = {
    ...
    search: function(query, dateCondition, callback) {
        ...
        var dateConditionString = '';
        if (dateCondition.from && dateCondition.to) {
            dateConditionString = '&FieldText=NRANGE{' + dateCondition.from + ',' + dateCondition.to + '}:TIMESTAMP';
        } else if (dateCondition.from) {
            dateConditionString = '&FieldText=GREATER{' + dateCondition.from + '}:TIMESTAMP';
        } else if (dateCondition.to) {
            dateConditionString = '&FieldText=LESS{' + dateCondition.to + '}:TIMESTAMP';
        }
