	        ...
	        if (err) {
	            ...
	            results.map(function(result)
	            {
	            	...
	            	for(;j<paths.length;j++)
	            	{
	            		...
	            		if (path.hash.indexOf(paths[j].hash) == 0) 
	            			break;
	            	}
